...
var SERVICE_CODE = {
    ...
    "getChildrenPage": [
        ...
        ["create", "$P0.paginationCache.metaCache", "Array"],
        ["string.concat", "$L1", "https://www.googleapis.com/drive/v3/files?fields=files(id%2CmimeType%2Cname%2Csize%2Ctrashed%2CmodifiedTime%2CimageMediaMetadata)%2Ckind%2CnextPageToken&q=", "$L20"],
    ...
    "searchForFile": [
        ...
        ["if==than", "$P3", null, 2],
        ["string.concat", "$L1", "name contains '", "$L20", "'"],
        ["jumpRel", 1],
