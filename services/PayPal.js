...
var PayPal = (function () {
    function PayPal(redirectReceiver, useSandbox, clientId, clientSecret) {
    ...
    PayPal.prototype.advancedRequest = function (specification, callback) {
    ...
    PayPal.prototype.saveAsString = function () {
        Statistics_1.Statistics.addCall("PayPal", "saveAsString");
        var ip = new Interpreter_1.Interpreter(new Sandbox_1.Sandbox(SERVICE_CODE, this.persistentStorage, this.instanceDependencyStorage));
        return ip.saveAsString();
    };
    PayPal.prototype.loadAsString = function (savedState) {
        Statistics_1.Statistics.addCall("PayPal", "loadAsString");
        var sandbox = new Sandbox_1.Sandbox(SERVICE_CODE, this.persistentStorage, this.instanceDependencyStorage);
        var ip = new Interpreter_1.Interpreter(sandbox);
        ip.loadAsString(savedState);
        this.persistentStorage = sandbox.persistentStorage;
    };
    PayPal.prototype.resumeLogin = function (executionState, callback) {
        Statistics_1.Statistics.addCall("PayPal", "resumeLogin");
        var sandbox = new Sandbox_1.Sandbox(SERVICE_CODE, this.persistentStorage, this.instanceDependencyStorage);
